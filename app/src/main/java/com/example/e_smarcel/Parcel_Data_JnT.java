...
public class Parcel_Data_JnT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceStance){
        ...
        setContentView(R.layout.activity_parcel_data_jn_t);
        ...
        if (ContextCompat.checkSelfPermission(Parcel_Data_JnT.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED){
            init();
        }
        else{
            ActivityCompat.requestPermissions(Parcel_Data_JnT.this, new String[]{Manifest.permission.CAMERA},101);
        }
        ...
        txtDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //date picker dialog
                datePickerDialog = new DatePickerDialog(Parcel_Data_JnT.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!trackNum.isEmpty() && !specKey.isEmpty() && !date.isEmpty()){
                    JNT jnt = new JNT(trackNum, specKey, date);
                    db = FirebaseDatabase.getInstance();
                    reference = db.getReference().child("admins").child("courierJNT");
                    reference.child(trackNum).setValue(jnt).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            Toast.makeText(Parcel_Data_JnT.this, "Successfully Inserted", Toast.LENGTH_SHORT).show();
    ...
    public void init(){
        cameraProviderListenableFuture = ProcessCameraProvider.getInstance(Parcel_Data_JnT.this);
        ...
        }, ContextCompat.getMainExecutor(Parcel_Data_JnT.this));
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(Parcel_Data_JnT.this, "Permissions Denied", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void bindImageAnalysis(ProcessCameraProvider processCameraProvider){
        ...
        imageAnalysis.setAnalyzer(ContextCompat.getMainExecutor(Parcel_Data_JnT.this), new ImageAnalysis.Analyzer() {
            @Override
